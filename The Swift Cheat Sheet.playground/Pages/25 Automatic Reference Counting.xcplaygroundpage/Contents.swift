...
//: To view the original page [click here - Automatic Reference Counting](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/automaticreferencecounting)
//:
//: -------------------
//:
