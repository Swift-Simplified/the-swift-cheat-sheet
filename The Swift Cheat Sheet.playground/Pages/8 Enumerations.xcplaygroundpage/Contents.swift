...
//: To view the original page [click here - Enumerations](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/enumerations)
//:
//: -------------------
//:
