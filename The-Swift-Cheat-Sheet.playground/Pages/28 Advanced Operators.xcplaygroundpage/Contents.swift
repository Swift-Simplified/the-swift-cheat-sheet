...
//:
//: ![Diagram](bitshiftUnsigned_2x.png)
...
//:
//: ![Diagram](bitshiftSignedFour_2x.png)
...
//:
//: ![Diagram](bitshiftSignedAddition_2x.png)
...
//:
//: ![Diagram](overflowUnsignedSubtraction_2x.png)
...
//:
//: ![Diagram](overflowSignedSubtraction_2x.png)
...
//: To view the original page [click here - Advanced Operators](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/advancedoperators)
//:
//: -------------------
//:
